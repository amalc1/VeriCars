...
import { CurrentFilters, Filters } from "@/lib/types";
...
interface CarFilterControlsProps {
  ...
  onClearFilter: (key: keyof CurrentFilters) => void;
}
  ...
  const filterSections = [
    {
      id: "make" as const,
      title: "Make",
      options: filters.makes.map((m) => ({ value: m, label: m })),
      currentValue: make,
